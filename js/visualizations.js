...
const Visualizations = (() => {
    ...
    function renderSpectrogram(containerId, features) {
        ...
        const layout = {
            ...plotlyLayout,
            xaxis: { ...plotlyLayout.xaxis, title: 'Time (s)' },
            yaxis: { ...plotlyLayout.yaxis, title: 'Frequency (Hz)' },
        };
        Plotly.newPlot(containerId, [trace], layout, plotlyConfig);
    }
    ...
    function renderPitch(containerId, features, color) {
        ...
        const layout = {
            ...plotlyLayout,
            xaxis: { ...plotlyLayout.xaxis, title: 'Time (s)' },
            yaxis: { ...plotlyLayout.yaxis, title: 'Pitch (Hz)' },
        };
        Plotly.newPlot(containerId, [trace], layout, plotlyConfig);
    }
    ...
    function renderLTAS(containerId, features, color) {
        ...
        const layout = {
            ...plotlyLayout,
            xaxis: { ...plotlyLayout.xaxis, title: 'Frequency (Hz)', type: 'log' },
            yaxis: { ...plotlyLayout.yaxis, title: 'Power (dB)' },
        };
        Plotly.newPlot(containerId, [trace], layout, plotlyConfig);
    }
    ...
    function renderValidation(containerId, data) {
        ...
        const layout = {
            ...plotlyLayout,
            xaxis: { ...plotlyLayout.xaxis, title: 'False Positive Rate (FPR)', range: [0, 1] },
            yaxis: { ...plotlyLayout.yaxis, title: 'True Positive Rate (TPR)', range: [0, 1] },
            showlegend: true,
